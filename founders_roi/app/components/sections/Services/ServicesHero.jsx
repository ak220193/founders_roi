...
export default function ServicesHero() {
  return (
    <section className="w-full bg-bg-primary text-white pt-36 pb-20 px-4 sm:px-8 lg:px-16 relative overflow-hidden select-none">
      {/* Ambient Top Light Flares */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[350px] bg-linear-to-b from-orange-500/5 via-transparent to-transparent blur-[140px] pointer-events-none" />
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#141414_1px,transparent_1px),linear-gradient(to_bottom,#141414_1px,transparent_1px)] bg-size-[4.5rem_4.5rem] mask-[radial-gradient(ellipse_60%_50%_at_50%_50%,#000_60%,transparent_100%)] opacity-30 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.1]">
            Build a <span className="bg-linear-to-r from-orange-400 via-amber-500 to-orange-600 bg-clip-text text-transparent">Growth Engine</span>, <br />
            Not Just Campaigns.
          </h1>
        ...
        <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full h-full">
          {services.map((item, i) => (
            ...
            >
              <div className="p-3 rounded-xl bg-neutral-900 border border-neutral-800 text-orange-400 group-hover:bg-linear-to-r group-hover:from-orange-500 group-hover:to-amber-500 group-hover:text-black group-hover:border-transparent transition-all duration-300 w-fit mb-4">
                <item.icon size={18} />
              </div>
